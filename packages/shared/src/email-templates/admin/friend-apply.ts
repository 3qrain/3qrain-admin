...
export function renderFriendApplyEmail(data: FriendApplyData): string {
  return emailLayout({
    ...
    body: `
      ...
      <a href="${data.adminUrl}/friend-links" style="display:inline-block;background:#4a90e2;color:#fff;padding:12px 28px;text-decoration:none;border-radius:6px;margin:20px 0 10px;font-weight:500" target="_blank">处理申请</a>`,
  })
}
